...
(define-test test-limits-of-case-extension
  "This limitation can be overcome if you use a label for the object
which you're testing against."
  (let* ((name #1="John")
         (lastname (case name (#1# "Doe")
                              ("Max" "Mustermann")
                              (t "Anonymous"))))
