...
(define-test test-many-kinds-params
   ...
   (assert-equal (func-with-funky-parameters 1) (list 1 nil 1 nil))
   (assert-equal (func-with-funky-parameters 1 :b 2) (list 1 2 1 (list :b 2)))
   (assert-equal (func-with-funky-parameters 1 :b 2 :c 3) (list 1 2 3 (list :b 2 :c 3)))
   (assert-equal (func-with-funky-parameters 1 :c 3 :b 2) (list 1 2 3 (list :c 3 :b 2))))
